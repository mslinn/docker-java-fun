...
scalacOptions in (Compile, doc) ++= baseDirectory.map {
  (bd: File) => Seq[String](
     ...
     "-doc-source-url", "https://github.com/mslinn/docker-java-fun/tree/master€{FILE_PATH}.scala"
  )
}.value
...
//  "com.github.docker-java"   %  "docker-java"     % "3.0.14" withSources(),
  "com.spotify"              %  "docker-client"   % "8.9.1"  withSources(),
